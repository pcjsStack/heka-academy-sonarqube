...
import courseParticipationData from '@/mock/courseParticipationData.json'
...
const filteredParticipants = computed(() => {
  if (!searchQuery.value) {
    return courseParticipationData.participants
  }

  return courseParticipationData.participants.filter((participant) =>
