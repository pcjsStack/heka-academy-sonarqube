<template>
  <BaseSideModal
    :title="t('pages.course.enrollUsers.title')"
    :z-index="99999999"
    customClass="left-0"
    :closeButton="true"
    @onClose="handleClose"
...
import { BaseSideModal, BaseText, BaseSelect, BaseButton } from '@/components/common'
import { t } from '@/utils/i18n'
import usersData from '@/mock/users.json'
import cohortsData from '@/mock/cohorts.json'
import rolesData from '@/mock/roles.json'

// No props needed - modal is conditionally rendered by parent
